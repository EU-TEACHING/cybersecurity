...
class LSTMAutoencoder(BaseModel):
    ...
    def _preprocess_data(self):
        ...
        # Transform the normal, anomaly and verification data
        ...
        # Create sequences: anomaly y
        self.verification_y_seq = create_sequences(self.verification_y, self.seq_time_steps)
        print("Verification target shape (#seqs, seq len): ", self.verification_y_seq.shape)
    ...
    def eval(self):
        ...
        # Verification set
        accuracy, precision, recall, f1 = get_eval_metrics(self.model,
